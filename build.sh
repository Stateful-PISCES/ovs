...
cd ../
./boot.sh
if [[ -e ~/p4c-behavioral/fr_argfile_sample/l2_switch.json ]]
then
  ./configure --with-dpdk=$DPDK_BUILD CFLAGS="-g -O2 -Wno-cast-align" \
              p4inputfile=~/p4c-behavioral/fr_argfile_sample/l2_switch.p4 \
              p4outputdir=./include/p4/src \
              p4frargfile=~/p4c-behavioral/fr_argfile_sample/l2_switch.json
else
  ./configure --with-dpdk=$DPDK_BUILD CFLAGS="-g -O2 -Wno-cast-align" \
